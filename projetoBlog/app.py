...
def conectar_db():
    # Estabelece conexão com o BD usando PyMySQL
...
def cadastro_usuario():
    ...
    #Verifica se o acesso foii via formulário
    if request.method == 'POST':
        nome_usuario = request.form['nome']
        email_usuario = request.form['email']
        senha_usuario = request.form['senha']
        #Verifica se os campos estào preenchidos.
...
def atualizar_usuario():
    ...
    #Verifica se o acesso foi cia formulário
    if request.method == 'POST':
